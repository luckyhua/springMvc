...
public class IDCardUtil {
	...
	public static String IDCardValidate(String IDStr) throws ParseException, NumberFormatException {
		
		String msg = "success";// 校验结果信息
		...
		if (isNumeric(Ai) == false) {
			msg = "身份证15位号码都应为数字 ; 18位号码除最后一位外，都应为数字。";
			return msg;
		}
